---
type: Reference
title: "Code Index: pgadmin"
description: "Aggregated code index for pgadmin folder"
timestamp: 2026-07-03T15:11:00Z
---

# Code Index: pgadmin

> This index aggregates code files in the [[pgadmin/]] directory.
...
serverDefinitions:
  ...
  servers:
    whiteboard:
      Name: "Whiteboard Database"
      Group: "Servers"
      Port: 5432
      Username: "whiteboard"
      Host: "whiteboard-db-postgresql.database.svc.cluster.local"
      SSLMode: "prefer"
      MaintenanceDB: "whiteboard"
